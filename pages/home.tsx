        ...
        <>
            ...
            <div className="layout bg-gradient-to-tr from-indigo-500 to-sky-400">
                ...
                <main className="flex flex-col items-center w-full px-10 gap-2 md:w-[768px]">
                    <section className="flex justify-between items-center bg-slate-200 w-full h-20 px-5 rounded-md shadow-lg mb-12">
                    ...
                    <div className="flex flex-col gap-5 w-full px-5 bg-slate-200  py-8 rounded-md shadow-lg mb-12">
                        <input
                            type="text"
